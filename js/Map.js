function Map(size, tileSize, scale, min_room, max_room) {
  this.generate = function(size, tileSize, scale, min_room, max_room) {
    this.size = size;
  ...
  var Weapon = function() {
    ...
    var type = ["club","knife","sword","axe","katana"];
    console.log("You found a", material[0,material.length - 1], type[random(0, type.length - 1)],"!");
  };
  ...
  this.generate(size, tileSize, scale, min_room, max_room);
};
